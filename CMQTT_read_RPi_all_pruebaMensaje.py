...
class General(object):
    def __init__(self):
        ...
        while self.Connected != True:
            while True:
                ...
                if self.vari == 0:
                    ctypes.windll.user32.MessageBoxA(0, "Se salio del ciclo", "Porque supuestamente se acabo", 1)
                    break
    ...
    def on_message(self, client, obj, msg):
        ...
        if msg.topic == "valor":
            if self.vari == 0:
                ctypes.windll.user32.MessageBoxA(0, "Llego mensaje", "Pero no guarda", 1)
        ...
        if msg.topic == "fin":
            ...
            self.vari = 0
            ctypes.windll.user32.MessageBoxA(0, "Fin", "Mensaje final", 1)
